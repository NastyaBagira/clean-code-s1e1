...
var editTask = function () {
  ...
  var containsClass = listItem.classList.contains("plan-task");
  //If class of the parent is .plan-task
  if (containsClass) {
  ...
  //toggle .plan-task on the parent.
  listItem.classList.toggle("plan-task");
};
